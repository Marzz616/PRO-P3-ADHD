...
<body>
  ...
  <home>
    ...
    <div class="faq-container answers jc-center col-6">
        ...
        require_once('faq-config.php');
        require_once('faq-database.php');
          ...
          <div class="col-6">
            <div class="bubble-2">
              ...
              <ul>
                ...
                <li><a href="../../contact.html">Call/Sms us</a></li>
              </ul>
            </div>
          </div>
          <div class="col-6">
          ...
          <div class="row align-items-center">
            <div class="col-sm-6 col-12">
              <ul class="footer-social">
                <li><a href="https://www.facebook.com/"><img src="..//img/footer/facebook2.png" alt=""><i
                      class="fab fa-facebook-f"></i></a></li>
                <li><a href="https://www.instagram.com/?hl=en"><img src="../img/footer/instagram2.png" alt=""><i
                      class="fab fa-instagram"></i></a></li>
                <li><a href="https://www.youtube.com/?app"><img src="../img/footer/youtube2.png" alt=""><i
